...
//     let curr = runners[i]
//     // fullNames.push(curr.first_name)
//     // fullNames.push(curr.last_name)
//     fullNames.push(`${curr.first_name} ${curr.last_name}`)
//   }
...
//   for (let i = 0; i < runners.length; i++){
//     let curr = runners[i]
//     firstNamesAllCaps.push(curr.first_name.toUpperCase())
//   }
// console.log(firstNamesAllCaps);

let firstNamesAllCaps = [];
  runners.map(x => firstNamesAllCaps.push(x.first_name.toUpperCase()))
console.log(firstNamesAllCaps)
...
//   for (let i = 0; i < runners.length; i++){
//     let curr = runners[i]
//     if (curr.shirt_size === 'L'){
//       runnersLargeSizeShirt.push(curr)
//     }
//   }
// console.log(runnersLargeSizeShirt);

let runnersLargeSizeShirt = runners.filter(x => x.shirt_size === 'L')
console.log(runnersLargeSizeShirt);
// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations and save the total into a ticketPriceTotal variable.
let ticketPriceTotal = runners.reduce((accum, curr) => accum + curr.donation, 0)
...
// Problem 1
  //Donations over 100
  let largeDonations = runners.filter(x => x.donation > 100)
  console.log(largeDonations)

// Problem 2
  //Name to lowecase
  let lowerCaseName = runners.map(x => x.last_name.toLowerCase())
  console.log(lowerCaseName)

// Problem 3
  //Add the donations less than 50
  //??
  let lowDonations = runners.reduce((accum, curr) => accum.donation > 50 + curr.donation, 0)
